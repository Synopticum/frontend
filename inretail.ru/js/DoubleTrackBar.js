function cDoubleTrackBar(Track, Tracker, Settings) {
	...
	this.Max = Settings.Max || 100;		this.MinPos = Settings.MinPos || 0;	this.MaxPos = Settings.MaxPos || 100;
	this.MinSpace = Settings.MinSpace || 0;
	this.RoundTo = Settings.RoundTo || 1;
	this.Margins = Settings.Margins || 0;
	this.AllowedValues = Settings.AllowedValues || false;
	this.Disabled = (typeof Settings.Disabled != 'undefined') ? Settings.Disabled : false;
	this.actLeft = Settings.actLeft || 0;
	this.actRight = Settings.actRight;
	...
	this.TrackerLeft = this.actLeft;
	
	if(this.actRight)
		var offset=this.actRight;
	else
		var offset=this.Track.offsetWidth;
	
	this.UpdateTracker(offset + this.FingerOffset);
